    ...
    <Helmet title={"Home"}>
      <section className="home py-10">
        <div className="max-w-7xl mx-auto px-4 lg:px-8 xl:max-w-full">
          <div>
            <h1 className="text-4xl text-center font-bold mb-2 lg:text-5xl">
              <ReactTyped
                strings={["Find a Place to Call Your Own"]}
                typeSpeed={60}
                backSpeed={40}
                backDelay={1000}
            ...
            <p className="text-base text-center text-gray-800 mb-4 mx-auto max-w-[50ch]">
              Browse through our extensive listings to find properties that suit
              your taste and budget. Your dream home awaits you here.
            </p>
            <form
              onSubmit={handleSubmit}
              className="mb-8 mx-auto max-w-[450px]"
            >
