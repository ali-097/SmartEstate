        ...
        <div className="max-w-7xl mx-auto px-4 lg:px-8 xl:max-w-full">
          <div className="mx-auto max-w-2xl lg:text-center">
            ...
            <p className="mt-6 text-lg leading-8 text-gray-600">
              ...
              <Link to={"/contact"} className="font-semibold text-gray-800">
                customer support
              </Link>{" "}
              team.
            </p>
          ...
          <div className="mx-auto mt-16 max-w-2xl sm:mt-20 lg:mt-24 lg:max-w-4xl">
            <div className="flex flex-col w-full gap-4">
              <Accordion
                ...
                answer="Our platform features a wide range of properties including apartments, houses, and Flats. We strive to provide a comprehensive selection to cater to all our user's needs."
              />
              <Accordion
                title="How can I trust the listings on your platform?"
                answer="We understand the importance of trust in real estate transactions. That's why we verify listings that can be idenitied by the verified tag. We also encourage users to do their own due diligence before making a transaction."
              />
              <Accordion
