      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-4 lg:px-8 xl:max-w-full lg:flex lg:items-center lg:gap-4">
          <div className="mx-auto lg:w-6/12 lg:text-center">
            ...
            <p className="mt-6 text-lg leading-8 text-gray-600 lg:mx-auto lg:max-w-[50ch]">
              ...
              assistance, feel free to reach out to us. Our team is always ready
              to assist you.
            </p>
          </div>
        ...
        {loading && (
          <div className="fixed inset-0 bg-gray-800 bg-opacity-75 flex items-center justify-center z-50">
            <div className="text-white text-xl">Sending your message...</div>
          </div>
        )}
        {sent && (
          <div className="fixed inset-0 bg-gray-800 bg-opacity-75 flex items-center justify-center z-50">
            <div className="text-white text-xl">Message sent successfully!</div>
          </div>
        )}
      </section>
    </Helmet>
