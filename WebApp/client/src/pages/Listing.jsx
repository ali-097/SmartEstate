            ...
            <div className="relative w-full h-[450px] lg:h-[500px]">
              {listing.imageUrls.map((url, index) => (
                <React.Fragment key={url}>
                  ...
                  <div
                    onClick={prevSlide}
                    className="flex items-center w-12 h-16 pl-2 absolute top-0 right-auto bottom-0 left-0 overflow-hidden m-auto z-[4] rounded-tr-full rounded-br-full bg-black/30 backdrop-blur-sm text-white cursor-pointer"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="24"
                  ...
                  <div
                    onClick={nextSlide}
                    className="flex items-center justify-end w-12 h-16 pr-2 absolute top-0 right-0 bottom-0 left-auto overflow-hidden m-auto z-[4] rounded-tl-full rounded-bl-full bg-black/30 backdrop-blur-sm text-white cursor-pointer"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="24"
                    ...
                    <ul className="mt-4 flex flex-wrap items-center text-[#303133] font-semibold text-sm gap-4 sm:gap-6">
                      ...
                      <li className="flex items-center gap-1">
                        ...
                        >
                          ...
                          <path
                            fill="currentColor"
                            d="M20 13V4.83C20 3.27 18.73 2 17.17 2c-.75 0-1.47.3-2 .83l-1.25 1.25c-.16-.05-.33-.08-.51-.08c-.4 0-.77.12-1.08.32l2.76 2.76c.2-.31.32-.68.32-1.08c0-.18-.03-.34-.07-.51l1.25-1.25a.828.828 0 0 1 1.41.59V13h-6.85c-.3-.21-.57-.45-.82-.72l-1.4-1.55c-.19-.21-.43-.38-.69-.5A2.251 2.251 0 0 0 5 12.25V13H2v6c0 1.1.9 2 2 2c0 .55.45 1 1 1h14c.55 0 1-.45 1-1c1.1 0 2-.9 2-2v-6h-2zm0 6H4v-4h16v4z"
                          />
                        </svg>
                        {listing.bathrooms > 1
                  ...
                  {!contact && (
                    <>
                      ...
                      <div className="w-full">
                        <button
                          ...
                          className={`flex w-full justify-center rounded-md px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 ${
                            currentUser && listing.userRef === currentUser._id
                              ...
                              : "bg-myblue hover:bg-indigo-600 focus-visible:outline-indigo-600"
                          } md:w-6/12 md:m-auto`}
                          disabled={
                            currentUser && listing.userRef === currentUser._id
                          }
                        ...
                        <p
                          className={`text-red-800 text-sm mt-2 flex w-full justify-center ${
                            loginError ? "" : "hidden"
                          }`}
                        >
                          You need to be logged in to contact the landlord
                        </p>
                      </div>
                    </>
                  )}
